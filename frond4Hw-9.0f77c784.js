...
})({"fznSA":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 51416;
...
const render = function() {
    listRef.innerHTML = urlList.map((url, index)=>`
      <li>
        <a href="${url}" target="_blank">${url}</a>
<button type="button" class = "delete" data-index ="${index}">\u{412}\u{438}\u{434}\u{430}\u{43B}\u{438}\u{442}\u{438}</button>
<button type="button" class = "edit" data-index ="${index}">\u{420}\u{435}\u{434}\u{430}\u{433}\u{443}\u{432}\u{430}\u{442}\u{438}</button>
</li>`).join("");
};
const save = function() {
...
},{}]},["fznSA","2R06K"], "2R06K", "parcelRequire4379", {})
